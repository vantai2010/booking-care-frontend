...
class ManageSpecialty extends Component {
    ...
    handleSaveSpecialty = async () => {
        let response = await createNewSpecialtyService(this.state)
                ...
                <div className="manage-specialty-container">
                    ...
                    <div className="add-new-specialty row">
                        ...
                        <div className="col-12 my-3">
                            <button className="btn btn-primary" onClick={() => this.handleSaveSpecialty()}><FormattedMessage id="admin.manage-specialty.save" /></button>
                        </div>
                    </div>
                </div>
            </>
